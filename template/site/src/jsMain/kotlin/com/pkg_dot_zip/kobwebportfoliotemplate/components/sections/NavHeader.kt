...
fun NavHeader() {
    Row(NavHeaderStyle.toModifier(), verticalAlignment = Alignment.CenterVertically) {
        ...
        Link("https://svit.ac", openExternalLinksStrategy = OpenLinkStrategy.IN_PLACE) {
...
//            Image(if (colorMode == ColorMode.DARK) Res.LOGO_DARK else Res.LOGO_LIGHT, "Logo", Modifier.height(2.cssRem).display(DisplayStyle.Block))
            SpanText(modifier = Modifier.height(2.cssRem).display(DisplayStyle.Block), text = "svit.ac")
        }
